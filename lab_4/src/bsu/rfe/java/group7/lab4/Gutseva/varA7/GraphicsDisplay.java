package bsu.rfe.java.group7.lab4.Gutseva.varA7;
...
public class GraphicsDisplay extends JPanel {
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        formatter.setDecimalFormatSymbols(dottedDouble);
            ...
            for (Double[] point : graphicsData) {
                String formattedDouble = formatter.format(point[0]);
                boolean flag = checkDigitsOrder(formattedDouble);
                if (flag) {
                    canvas.setColor(Color.RED);
                } else {
    ...
    private static boolean checkDigitsOrder(String input) {
        String cleanedInput_1 = input.replace("-", "");
        String cleanedInput = cleanedInput_1.replace(".", "");
        System.out.println(cleanedInput);
        for (int i = 0; i < cleanedInput.length() - 1; i++) {
            char currentDigit = cleanedInput.charAt(i);
            char nextDigit = cleanedInput.charAt(i + 1);
